...
namespace RelaxKundura3.Data.Migrations
{
    ...
    [Migration("20240113165116_sepet")]
    partial class sepet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RelaxKundura3.Models.Kategori", b =>
                {
            ...
            modelBuilder.Entity("RelaxKundura3.Models.Sepet", b =>
                {
            ...
            modelBuilder.Entity("RelaxKundura3.Models.SepetUrun", b =>
                {
            ...
            modelBuilder.Entity("RelaxKundura3.Models.Urun", b =>
                {
                    ...
                    b.Property<string>("UrunCinsiyet")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RelaxKundura3.Models.SepetUrun", b =>
                {
                    b.HasOne("RelaxKundura3.Models.Sepet", null)
                        .WithMany("SepetUrunler")
                        .HasForeignKey("SepetId");

                    b.HasOne("RelaxKundura3.Models.Urun", "Urun")
                        .WithMany()
            ...
            modelBuilder.Entity("RelaxKundura3.Models.Urun", b =>
                {
                    b.HasOne("RelaxKundura3.Models.Kategori", "KategoriFk")
                        .WithMany()
